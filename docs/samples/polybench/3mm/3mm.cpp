...
void kernel_3mm_node0(hls::stream<bool> &v0, float v1[180][190],
                      hls::stream<bool> &v2, float v3[190][210],
                      float v4[180][210]) { // L8
#pragma HLS inline
...
void kernel_3mm_node1(float v79[190][220], float v80[220][210],
                      hls::stream<bool> &v81,
                      float v82[190][210]) { // L105
#pragma HLS inline
...
void kernel_3mm_node2(float v192[180][200], float v193[200][190],
                      hls::stream<bool> &v194,
                      float v195[180][190]) { // L244
#pragma HLS inline
...
void kernel_3mm(ap_int<32> v255, ap_int<32> v256, ap_int<32> v257,
                ap_int<32> v258, ap_int<32> v259, float v260[180][190],
                float v261[180][190], float v262[180][200],
                float v263[200][190], float v264[190][210],
                float v265[190][210], float v266[190][220],
                float v267[220][210],
                float v268[180][210]) { // L324
