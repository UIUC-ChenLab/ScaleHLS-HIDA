...
void kernel_atax_node1(float v0[390][410], hls::stream<bool> &v1, float v2[390],
                       float v3[410],
                       int v4) { // L4
#pragma HLS inline
...
void kernel_atax_node2(float v171[390][410], float v172[410],
                       hls::stream<bool> &v173, float v174[390],
                       int v175) { // L216
#pragma HLS inline
...
void kernel_atax_node0(float v342[390][410], float v343[410],
                       float v344[390][410], float v345[390], float v346[410],
                       float v347[390]) { // L391
...
void kernel_atax(ap_int<32> v351, ap_int<32> v352, float v353[390][410],
                 float v354[390][410], float v355[410], float v356[410],
                 float v357[390],
                 float v358[390]) { // L443
