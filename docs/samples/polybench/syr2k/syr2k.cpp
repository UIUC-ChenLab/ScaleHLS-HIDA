...
void kernel_syr2k_node1(float v0[240][200], float v1[240][200],
                        float v2[240][240], int v3, float v4,
                        float v5) { // L20
...
void kernel_syr2k_node0(float v217[240][200], float v218[240][200],
                        float v219[240][240], float v220,
                        float v221) { // L333
...
void kernel_syr2k(ap_int<32> v223, ap_int<32> v224, float v225, float v226,
                  float v227[240][240], float v228[240][200],
                  float v229[240][200]) { // L339
