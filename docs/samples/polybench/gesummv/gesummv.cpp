...
void kernel_gesummv_node0(float v0[250], float v1[250][250], float v2[250][250],
                          float v3[250], float v4[250], float v5,
                          float v6) { // L9
#pragma HLS inline
...
void kernel_gesummv(ap_int<32> v202, float v203, float v204,
                    float v205[250][250], float v206[250][250], float v207[250],
                    float v208[250],
                    float v209[250]) { // L230
