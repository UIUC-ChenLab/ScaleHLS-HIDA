...
void kernel_2mm_node0(hls::stream<bool> &v0, float v1[180][190],
                      float v2[190][220], float v3[180][220],
                      float v4) { // L6
#pragma HLS inline
...
void kernel_2mm_node1(float v109[180][210], float v110[210][190],
                      hls::stream<bool> &v111, float v112[180][190],
                      float v113) { // L135
#pragma HLS inline
...
void kernel_2mm(ap_int<32> v218, ap_int<32> v219, ap_int<32> v220,
                ap_int<32> v221, float v222, float v223, float v224[180][190],
                float v225[180][190], float v226[180][210],
                float v227[210][190], float v228[190][220],
                float v229[180][220]) { // L266
