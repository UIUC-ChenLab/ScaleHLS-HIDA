...
void kernel_bicg_node0(float v0[390], float v1[410], float v2[410][390],
                       float v3[390],
                       float v4[410]) { // L16
...
void kernel_bicg(ap_int<32> v161, ap_int<32> v162, float v163[410][390],
                 float v164[390], float v165[410], float v166[390],
                 float v167[410]) { // L217
