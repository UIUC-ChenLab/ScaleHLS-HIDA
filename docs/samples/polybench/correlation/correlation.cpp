...
void kernel_correlation_node0(hls::stream<bool> &v0, float v1[260][240],
                              float v2[240][240]) { // L27
#pragma HLS inline
...
void kernel_correlation_node1(hls::stream<bool> &v145, float v146[240],
                              hls::stream<bool> &v147, float v148[240],
                              hls::stream<bool> &v149, float v150[260][240],
...
void kernel_correlation_node2(float v162[260][240], hls::stream<bool> &v163,
                              float v164[240], hls::stream<bool> &v165,
                              float v166[240],
                              float v167) { // L265
#pragma HLS inline
  v163.read();                                  // L270
...
void kernel_correlation_node3(hls::stream<bool> &v182, float v183[240],
                              hls::stream<bool> &v184, float v185[240],
...
void kernel_correlation_node4(float v192[260][240], hls::stream<bool> &v193,
                              float v194[240],
                              float v195) { // L306
#pragma HLS inline
...
void kernel_correlation(ap_int<32> v204, ap_int<32> v205, float v206,
                        float v207[260][240], float v208[260][240],
                        float v209[260][240], float v210[260][240],
                        float v211[240][240], float v212[240], float v213[240],
                        float v214[240], float v215[240], float v216[240],
                        float v217[240], float v218[240],
                        float v219[240]) { // L323
...
#pragma HLS array_partition variable = v207 cyclic factor = 20 dim = 1
  ...
  kernel_correlation_node1(v236, v217, v235, v214, v233, v208, v238,
                           v206);             // L359
