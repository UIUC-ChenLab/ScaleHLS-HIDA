...
void kernel_symm_node0(float v0[200][200], float v1[200][240],
                       float v2[200][240], float v3, float v4,
                       float v5) { // L6
#pragma HLS inline
...
void kernel_symm(ap_int<32> v313, ap_int<32> v314, float v315, float v316,
                 float v317[200][240], float v318[200][200],
                 float v319[200][240]) { // L432
